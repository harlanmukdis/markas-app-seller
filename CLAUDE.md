...
Backend: CodeIgniter 3 + MySQL + JWT at `http://localhost/markas/api/v1` (**port 80, not 8080**), currently at tag **v2.2.0**. The contract lives in `docs/API-SELLER-APP.md` — read it before touching anything in `lib/core/data`, and note that document predates the v2.2 refactor.
